...
import { FaBold, FaHeading, FaItalic, FaListOl, FaListUl, FaQuoteLeft, FaRedo, FaStrikethrough, FaUnderline, FaUndo, FaImage, FaTable, FaSave, FaTimesCircle } from "react-icons/fa";

const MenuBar = ({ editor, exitEditor, saveContent }) => {
