...
const ChapterPageHeaderButtons = ({ action, tutorial, saveContent, navigate, subject, field, unit, chapterNumber, currentPage, handleAddPage, handleDeletePage, handleAddChapter, handleDeleteUnit, handleAddUnit }) => {
